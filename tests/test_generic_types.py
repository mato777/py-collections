...
from src.py_collections.collection import Collection, T
...
class TestCollectionGenericTypes:
    ...
    def test_mixed_type_collection(self):
        ...
        mixed_collection: Collection[object] = Collection([1, "hello", {"key": "value"}])
    ...
    def test_pydantic_model_with_nested_models(self):
        ...
        try:
            ...
            class Contact(BaseModel):
                ...
                email: str
                phone: str
                addresses: PydanticList[Address]
            ...
            contacts: Collection[Contact] = Collection([
                Contact(
                    ...
                    addresses=[
                        ...
                        Address(street="456 Oak Ave", city="Los Angeles", country="USA", postal_code="90210")
                    ]
                ),
                Contact(
                    name="Bob Smith",
                    ...
                    phone="+1-555-0202",
                    addresses=[
                        Address(street="789 Pine Rd", city="Chicago", country="USA", postal_code="60601")
                    ]
                )
            ])
            ...
            new_contact = Contact(
                ...
                phone="+1-555-0303",
                addresses=[
                    Address(street="321 Elm St", city="Boston", country="USA", postal_code="02101")
                ]
            )
