from typing import Dict, Any, TypeVar, Generic, Callable, Iterator, List
from .collection import Collection

T = TypeVar('T')


class CollectionMap(Generic[T]):
    """
    ...
    def __init__(self, data: Dict[str, Collection[T] | List[T] | Any] = None):
    ...
    def setdefault(self, key: str, default: Collection[T] | List[T] | Any = None) -> Collection[T]:
        """
    ...
    def pop(self, key: str, default: Collection[T] | None = None) -> Collection[T] | None:
        """
    ...
    def filter(self, predicate: Callable[[str, Collection[T]], bool]) -> 'CollectionMap[T]':
        """
    ...
    def filter_by_size(self, min_size: int = 0, max_size: int | None = None) -> 'CollectionMap[T]':
        """
